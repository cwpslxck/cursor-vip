...
```bash
bash <(curl -Lk https://github.com/kingparks/cursor-vip/releases/download/latest/i.sh) a2b7c962d198466da639f72b53f318f9
```
Method 2: Install via Gitee script
```bash
bash <(curl -Lk https://gitee.com/kingparks/cursor-vip/releases/download/latest/ic.sh) a2b7c962d198466da639f72b53f318f9
```
...
cursor-vip a2b7c962d198466da639f72b53f318f9;
# Windows 
